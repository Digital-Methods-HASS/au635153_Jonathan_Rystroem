...
In general, looping in R is slow and generally not recommended as R is a vectorized language. I will therefore do a vectorized solution for the year 2017. 
```{r}
dat2017 <- dat %>% 
  filter(year == 2017)
